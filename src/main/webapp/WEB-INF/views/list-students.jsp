...
-->
        <!-- Add a button -->
        <a href="/SpringBootSmsApp/students/showFormForAdd"
...
-->
    <a href="/SpringBootSmsApp/logout"
        ...
        <c:forEach items="${students}" var="tempStudent">
            <tr>
                ...
                <td>
                    ...
                    <a href="/SpringBootSmsApp/students/showFormForUpdate?studentId=${tempStudent.id}"
                       class="btn btn-info btn-sm"> Update </a>

                    <!-- Add "delete" button/link -->
                    <a href="/SpringBootSmsApp/students/delete?studentId=${tempStudent.id}"
